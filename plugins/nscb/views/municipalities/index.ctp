<div class="municipalities index">
	...
	<tr<?php echo $class;?>>
		...
		<td><?php echo $municipality['Municipality']['code']; ?>&nbsp;</td>
		<td><?php echo $municipality['Municipality']['income_class']; ?>&nbsp;</td>
		<td><?php echo $municipality['Municipality']['voters']; ?>&nbsp;</td>
		<td><?php echo $municipality['Municipality']['population']; ?>&nbsp;</td>
		<td><?php echo $municipality['Municipality']['land_area']; ?>&nbsp;</td>
		<td>
