<div class="provinces index">
	...
	<tr<?php echo $class;?>>
		...
		<td><?php echo $province['Province']['income_class']; ?>&nbsp;</td>
		<td><?php echo $province['Province']['voters']; ?>&nbsp;</td>
		<td><?php echo $province['Province']['population']; ?>&nbsp;</td>
		<td><?php echo $province['Province']['land_area']; ?>&nbsp;</td>
		<td>
