...
<h2><?php  __('Province');?></h2>
	<dl><?php $i = 0; $class = ' class="altrow"';?>
		...
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $province['Province']['code']; ?>
			&nbsp;
		</dd>
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Income Class'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $province['Province']['income_class']; ?>
			&nbsp;
		</dd>
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Voters'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $province['Province']['voters']; ?>
			&nbsp;
		</dd>
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Population'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $province['Province']['population']; ?>
			&nbsp;
		</dd>
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Land Area'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $province['Province']['land_area']; ?>
			&nbsp;
		</dd>
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Region'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $this->Html->link($province['Region']['name'], array('controller' => 'regions', 'action' => 'view', $province['Region']['id'])); ?>
			&nbsp;
		</dd>
	</dl>
</div>
...
<div class="related">
	...
	<?php
		...
		<tr<?php echo $class;?>>
			...
			<td><?php echo $city['income_class'];?></td>
			<td><?php echo $city['voters'];?></td>
			<td><?php echo $city['land_area'];?></td>
...
<div class="related">
	...
	<?php
		...
		<tr<?php echo $class;?>>
			...
			<td><?php echo $municipality['code'];?></td>
			<td><?php echo $municipality['income_class'];?></td>
			<td><?php echo $municipality['voters'];?></td>
			<td><?php echo $municipality['population'];?></td>
			<td><?php echo $municipality['land_area'];?></td>
