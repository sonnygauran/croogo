 ...
 */
	public $settings = array(
		...
		// Theme options
		'theme_advanced_buttons1' => 'fullscreen,removeformat,search,replace,|,bold,italic,strikethrough,|,bullist,numlist,blockquote,sub,sup,charmap|,link,unlink,anchor,image,|,tablecontrols',
		//These rows need to be explicitly blank or they won't hide
		...
		'theme_advanced_resizing' => true,
                ...
                /**
                 * Removed the following buttons for simpler formatting:
                 * 
                 * 'underline,justifyleft,justifycenter,justifyright,justifyfull,styleselect,formatselect,fontselect,fontsizeselect',cut,copy,paste,pastetext,pasteword,outdent,indent,undo,redo,code,forecolor,backcolor,emotions,iespell,media,advhr,print,ltr,rtl,insertlayer,moveforward,movebackward,absolute,styleprops,cite,abbr,acronym,del,ins,attribs,visualchars,nonbreaking,template,pagebreak,visualaid',
