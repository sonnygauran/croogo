...
<style type="text/css">
    .loader {
        background: white url(<?= $this->webroot ?>theme/weatherph_compact/img/loader-twirl.gif) no-repeat center center;
        ...
        <div id="info">
            ...
            <div class="detail-page-link" style="text-align: center;">
                <h2 style="height: 21px; text-align: center; width: 195px;">
                    <a href="<?= Router::url('/') ?>view" style="background: url(<?= $this->webroot ?>theme/weatherph_compact/img/arrow.png) no-repeat left center; padding-left: 40px; margin: 0 auto;">
                        More Details
                    </a>
                </h2>
            </div>
