<div class="content">
    <section class="main">
        <div class="posts">
            ...
            <img class="figure" src="../theme/weatherph/img/fig01.png" alt="" />
            ...
            <img class="figure" src="../theme/weatherph/img/fig02.png" alt="" />
            <p>Fig. 2 – shows the clockwise rotation of a Tropical Cyclone in the Southern hemisphere. Image credit: NOAA.</p>
            <img class="figure" src="../theme/weatherph/img/fig03.png" alt="" />
            ...
            <img class="figure" src="../theme/weatherph/img/fig04.png" alt="" />
