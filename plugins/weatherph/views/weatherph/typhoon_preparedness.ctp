<div id="content">
    <section class="main posts">
        ...
        <h3>What To Do Before A Typhoon</h3>
        <ul>
            <li>Inspect your house if necessary repair/fixing is needed. (eg. Roof, doors, windows, ceilings)</li>
            <li>Before typhoon strikes, you must clean up your house’s drainage system so it won’t get clogged up.</li>
            <li>Store an adequate supply of food and water that would last for a few days. Canned goods are ideal especially if cooking is not possible.</li>
            <li>Put everything in your house in an elevated position especially items that generate electricity so that water won’t penetrate into them in case floodwater rushes inside your house.</li>
            <li>Harvest crops that can be yielded immediately.</li>
            <li>For fishing folk, place boats in a safe area.</li>
            ...
            <li>Frequently listen to your local radio, television or internet (www.typhoon2000.com / www.weather.com.ph ) for storm advisories on the progress of the typhoon.</li>
        </ul>

        <h3>What To Do During A Typhoon</h3>
        <ul>
            <li>Stay inside the house and keep calm. Postpone any travel.</li>
            <li>Monitor to your local radio, television or internet (www.typhoon2000.com / www.weather.com.ph ) for storm advisories on the progress of the typhoon.</li>
        ...
        <h3>What To Do After A Typhoon</h3>
        <ul>
            <li>Monitor to your radio, television or internet (www.typhoon2000.com / www.weather.com.ph ) for storm advisories on the progress of the typhoon.</li>
            ...
            <li>Have a knowledgeable person inspect electrical connections before using electrical appliances.</li>
            ...
            <li>Boil water before drinking it to avoid diseases.</li>
            <li>Avoid contaminated food resulting from the lack of electricity and refrigeration.</li>
            <li>Do not let water accumulate in tires, cans or pots to avoid creating a favorable condition for mosquito breeding that can cause dengue.</li>
        </ul>
