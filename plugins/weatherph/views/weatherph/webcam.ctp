<div class="content">
    <section class="main">
        ...
        <video width="720" height="405" poster="<?php echo Configure::read('Data.movies'); ?>as_ph_manilashang.jpg" controls>
        ...
        <hr/>
        <p>Amanpulo</p>
        <video width="720" height="405" poster="<?php echo Configure::read('Data.movies'); ?>as_ph_amanpulo.jpg" controls>
