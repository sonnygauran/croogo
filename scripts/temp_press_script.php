<?php
//$location = "/home/gemeuber/web/weather.com.ph/views/themed/weatherph/webroot/img/layers";
$location = "/home/gemeuber/web/htc/scripts";
$res = "+1 hour";
$startdate = date('YmdHis');
$enddate = date('YmdHis', strtotime('+1hour',strtotime($startdate)));
echo $startdate;
echo "\n$enddate";
...
foreach($coordinates as $coordinate_key => $coordinate_value){
    foreach($properties as $property_key => $property_value){
        while (strtotime($start) < strtotime($end)){
            ...
            echo "\n $url \n";
            exec("wget -O '$location {$coordinate_key}_{$property_key}.png' '$url'");
