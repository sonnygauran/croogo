...
<?php echo $this->Form->create('MapViewType');?>
	<fieldset>
		<legend><?php __('Edit Map View Type'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('MapViewType.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('MapViewType.id'))); ?></li>
