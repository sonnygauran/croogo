...
<section class="main clear">
	<div class="map floating" id="map">
		<div class="infoPane center">
			
			<h6 class="center">Makati</h6>
			...
			<table>
				<tbody>
					<tr>
						<td class="param">TEMP</td>
						<td class="output">31&deg;</td>
					</tr>
					<tr>
						<td class="param">WIND</td>
						<td class="output">12km/h</td>
					</tr>
					<tr>
						<td class="param">RAIN</td>
						...
						<tbody>
							<tr>
								...
								<td class="weatherIcon">
									<?php echo $this->Html->image('sunny.png'); ?>
								</td>
								<td class="output">31&deg;</td>
							</tr>
							<tr>
								<td>6PM</td>
								<td class="weatherIcon">
									<?php echo $this->Html->image('overcast.png'); ?>
								</td>
							...
							<tr>
								<td>9PM</td>
								<td class="weatherIcon">
									<?php echo $this->Html->image('cloudy2_night.png'); ?>
								</td>
							...
							<tr>
								<td>12AM</td>
								<td class="weatherIcon">
									<?php echo $this->Html->image('cloudy3_night.png'); ?>
